      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <div className="px-3 py-2 bg-emerald-500/10 text-emerald-300 rounded-lg text-sm capitalize">
              {personality.tone}
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {personality.knowledge_focus.map((focus, i) => (
                <span
                  key={i}
                  className="px-3 py-1 bg-emerald-500/10 text-emerald-300 rounded-full text-sm capitalize"
                >
                  {focus}
                </span>
              ))}
        ...
        {personality.backstory && (
          <div>
            <div className="text-xs text-green-200/60 mb-2">Backstory</div>
            <div className="text-sm text-green-200/80 bg-[#0a0f12] p-3 rounded-lg border border-emerald-500/10">
              {personality.backstory}
            </div>
          </div>
        )}
